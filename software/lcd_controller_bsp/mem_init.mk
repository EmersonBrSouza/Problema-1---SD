...
# Memory: main_memory
MEM_0 := Main_main_memory
$(MEM_0)_NAME := main_memory
...
$(MEM_0)_HIERARCHICAL_PATH := main_memory
$(MEM_0)_WIDTH := 32
...
.PHONY: main_memory
main_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
