...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_rsp_xbar_mux.sv"        -work rsp_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_cmd_xbar_mux.sv"        -work cmd_xbar_mux                                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_cmd_xbar_demux.sv"      -work cmd_xbar_demux                                                                   
  vlog -sv "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_id_router.sv"           -work id_router                                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_addr_router.sv"         -work addr_router                                                                      
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/Main_irq_mapper.sv"                            -work irq_mapper                                                                       
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L cmd_xbar_mux -L cmd_xbar_demux -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L cmd_xbar_mux -L cmd_xbar_demux -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L onchip_memory2_0 -L nios2_qsys_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
