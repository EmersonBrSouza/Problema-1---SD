...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_rsp_xbar_mux.sv"        -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                   -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_cmd_xbar_mux.sv"        -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_cmd_xbar_demux.sv"      -work cmd_xbar_demux                                                                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_id_router.sv"           -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0_addr_router.sv"         -work addr_router                                                                      
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Main_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_mm_interconnect_0.v"                      -work mm_interconnect_0                                                                
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_onchip_memory2_0.v"                       -work onchip_memory2_0                                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0_jtag_debug_module_sysclk.v"  -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0_jtag_debug_module_tck.v"     -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0_jtag_debug_module_wrapper.v" -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0_oci_test_bench.v"            -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Main_nios2_qsys_0_test_bench.v"                -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/Main.v"                                                                                                                                          
fi
